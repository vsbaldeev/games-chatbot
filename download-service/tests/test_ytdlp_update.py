"""Daily yt-dlp self-update job tests, scoped to this service.
...
from ytdlp_update import YTDLP_PACKAGE_SPEC, check_and_update, newer_version_available

ISDIR_TARGET = "ytdlp_update.os.path.isdir"
VERSION_TARGET = "ytdlp_update.importlib.metadata.version"
RUN_PIP_TARGET = "ytdlp_update.run_pip"
KILL_TARGET = "ytdlp_update.os.kill"
