...
from src.bot.jobs import RoastJobManager, RolesJobManager, SilenceSweepJobManager, ResetModelJobManager
...
def main() -> None:
    ...
    for job_manager in [RoastJobManager(), RolesJobManager(), SilenceSweepJobManager(), ResetModelJobManager()]:
