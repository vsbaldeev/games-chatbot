...
async def __generate_round(
    ...
    system_prompt = (
        ...
        "Д1: <короткое действие 2-5 слов>\n"
        "Д2: <короткое действие 2-5 слов>\n"
        "Д3: <короткое действие 2-5 слов>\n"
        "Д4: <короткое действие 2-5 слов>\n\n"
...
async def __generate_coop_round(
    ...
    if round_number == 1:
        system_prompt = (
            ...
            "Д2: <кооперативное действие 2-5 слов>\n"
            "Д3: <кооперативное действие 2-5 слов>\n"
            "Д4: <кооперативное действие 2-5 слов>\n\n"
            "Только русский язык. Никакого другого текста."
        )
        user_prompt = (
...
async def __generate_narrative(
    ...
    user_prompt = (
        ...
        + "\n".join(player_lines)
        + f"\n\nНапиши единый связный смешной нарратив (3-5 предложений). "
