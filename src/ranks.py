...
RANKS = [
    ...
    Rank("Нашёл кнопку включения",         "🔌",   10),
    Rank("Гуглит что такое FPS",           "🔍",   25),
    Rank("Казуал с амбициями",             "🕹️",   45),
    Rank("Мобилка была лучше",             "📱",   70),
    Rank("Диванный эксперт",               "🛋️",  100),
    Rank("Ночная легенда своей комнаты",   "🌙",  140),
    Rank("Хардкор в теории",               "📖",  190),
    Rank("Задрот в отрицании",             "😤",  250),
    Rank("Знаток турецкого PS Store",      "🇹🇷",  320),
    Rank("Гриндер без пенсии",             "⚙️",  400),
    Rank("Легенда среди своих",            "🔥",  500),
    Rank("Скоро купит геймкресло",         "🪑",  630),
    Rank("Аватарка — скриншот из GTA",     "🖼️",  780),
    Rank("Ветеран диванных войн",          "🎖️",  960),
    Rank("Батя чата",                      "👑", 1200),
]
