...
- Преемственность: никогда не противоречь переданным эпизодам и фактам канона.
  Законченное разовое событие остаётся законченным (дом не красится с нуля дважды,
  выкопанный колодец остаётся выкопанным). Отсылки к прошлым событиям приветствуются —
  именно так посты становятся сериалом.
