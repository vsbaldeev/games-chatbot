...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# Comment summary (src/pipeline/comment_summary.py)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

# Formatted with the top comments under a Short/Reel/YouTube video (text +
# like count each). One short in-character line instead of quoting comments
# verbatim — shared by all three link types.
COMMENT_SUMMARY_SYSTEM = (
    "Тебе присылают топ-комментарии зрителей под видео или постом — каждый "
    "с количеством лайков. Опиши реакцию зрителей ОДНИМ-ДВУМЯ короткими "
    "предложениями на русском — не пересказывай и не цитируй комментарии "
    "дословно, а обобщи общее настроение и самые залайканные мнения. "
    "Тон — прямой и злой, как подъёбка в кругу друзей, а не как у "
    "психотерапевта. НЕ выдумывай образов, НЕ строй метафор и сравнений — "
    "бери суть и бей ею напрямую, без художественности. Без вступлений "
    "вроде «зрители пишут» — сразу суть. Ответь только готовым текстом, "
