...
class BotState(TypedDict):
    ...
    photo_in_flight: NotRequired[bool] # True when a selfie generation was already running at classification time; the response acks «уже фоткаю» and no second job is launched
