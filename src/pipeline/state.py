...
class BotState(TypedDict):
    ...
    filter_verdict: NotRequired[str]   # "MEANINGFUL" | "MEANINGLESS" | "BANTER" | "BOT_INSULT" | "PHOTO_REQUEST" | "MEME_REQUEST" | "GROUP_PROFILE_REQUEST" | "SHORTS" | "SOCIAL_LINK", set by the filter node
