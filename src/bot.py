...
GAMES_PROMPTS = [
    (
        ...
        "Для каждой игры вызови get_ps_store_price_tr чтобы получить ссылку и цену в турецком PS Store. "
        "Обязательно укажи: есть ли кросплей с PC, сколько игроков поддерживается онлайн, цену/скидку в TRY и ссылку в PS Store."
    ),
    (
        ...
        "Для каждой игры вызови get_ps_store_price_tr чтобы получить ссылку и актуальную цену в TRY. "
        "Расскажи: кросплей с PC, сколько игроков онлайн, стоит ли брать, цена и ссылка на турецкий PS Store."
    ),
    (
        ...
        "Для каждой игры вызови get_ps_store_price_tr — укажи цену в TRY и ссылку на турецкий PS Store. "
        "Для каждой: кросплей с PC и максимальное число игроков онлайн."
    ),
    (
        ...
        "Для каждой вызови get_ps_store_price_tr — нужна цена в TRY и ссылка на турецкий PS Store. "
...
async def cmd_coop(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await __send_agent_reply(
        ...
        username,
        (
            f"Найди одну подходящую игру для кооп-сессии чата на от 3 до 8 игроков. "
            f"Используй find_coop_games(3, offset={coop_offset}) для поиска кандидатов на PS5. "
            f"Выбери самый интересный вариант — PS5-эксклюзив или игра с кросплеем с PC. "
            f"Затем вызови get_ps_store_price_tr для выбранной игры — нужна цена в TRY и ссылка на турецкий PS Store. "
            f"Расскажи: название, жанр, максимальное число онлайн-игроков, кросплей с PC, цена в TRY, ссылка."
        ),
    )
