...
ALL_ACHIEVEMENTS: list[Achievement] = [
    ...
    # --- animations (GIFs) ---
    Achievement(
        "animation_1", "🎬", "Тонкий намек",
        "1 GIF. Ты удачно подчеркнул суть момента. Поздравляем, ты открыл для себя искусство визуального акцента."
        ),

    Achievement(
        "animation_10", "📽️", "Мастер контекста",
        "10 GIF. Твои мемы всегда к месту. По крайней мере, ты сам искренне веришь, что они идеально дополняют диалог."
        ),

    Achievement(
        "animation_25", "🌀", "Иллюстратор мыслей",
        "25 GIF. Зачем подбирать слова, когда есть мем, который скажет всё за тебя? Ты на пути к званию главного визуализатора чата."
        ),

    Achievement(
        "animation_50", "🎞️", "Король метафор",
        "50 GIF. Ты находишь гифку под любую ситуацию. Твои собеседники теперь не просто читают текст, а смотрят полноценное шоу."
        ),

    Achievement(
        "animation_100", "🤯", "Живой комментарий",
        "100 GIF. Твоя способность подчеркивать суть диалога мемами достигла абсурда. Ты — ходячий закадровый голос, только в картинках."
        ),
