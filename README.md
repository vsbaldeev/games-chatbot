...
gentle by default, roasting only when someone invites it) or to stay quiet. Three
times a week at 17:00 Moscow Time — Monday, Wednesday and Saturday — Жора
posts a short 2–3 sentence episode from his village life to every chat, each day in
its own format: a Saturday plain text story, a Wednesday ~30-second voice note in
the Silero voice, where the caption is
only a one-line teaser and the full story has to be listened to, or a Monday selfie
