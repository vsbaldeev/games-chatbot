...
LLM (response) Groq gpt-oss-120b → OpenRouter google/gemma-4-31b-it:free → z-ai/glm-5.2:free (cross-provider fallback chain; Llama was decommissioned by Groq and is no longer free anywhere; GLM leg added because Gemma's shared free pool was rate-limiting too often)
